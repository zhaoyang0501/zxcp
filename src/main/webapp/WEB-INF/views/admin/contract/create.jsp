				...
				<div class="row-fluid ">
					<div class="span12">
						<div class="content-widgets light-gray">
							...
							<form action="${pageContext.request.contextPath}/admin/contract/save" method="post" id=''>
							...
							<div class="control-group">
								<label for="title" class="control-label">合同有效期起：</label>
								<div class="controls">
							...
							<div class="control-group">
								<label for="title" class="control-label">合同有效期止：</label>
								<div class="controls">
									<div class=" input-append date">
