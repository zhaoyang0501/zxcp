...
<div>
	      <table class="table table-striped" id='dt_table_view'>
							...
							<tr >
								<td class="center"><a href="${pageContext.request.contextPath}/contests/${contest.id }/problems/${bean.problem.id }">  ${bean.id }</a></td>
								<td class="center"><a href="${pageContext.request.contextPath}/contests/${contest.id }/problems/${bean.problem.id }"> ${bean.problem.name }</a></td>
